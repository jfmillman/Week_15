...
public class DefaultJeepOrderDao implements JeepOrderDao {
  ...
  //This will return a customers information
  ...
  public SqlParams generateInsertSql(Option option, Long orderPK) {
   ...
   * @return
   */
  public SqlParams generateInsertSql(Customer customer, Jeep jeep, Color color,
