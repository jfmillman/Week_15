...
public class DefaultJeepSalesDao implements JeepSalesDao {
  ...
  //WEEK 15: fetchJeeps gets the model ID and trim level. We created a has map for the model ID and trim level and return a row mapper
  @Override
...
//WEEK 15: jeep builder builds the jeep info
      @Override
