...
//WEEK 15: Spring will intercept a no such element exception, it will call this method, and then will pass in the exception. This is for BAD_REQUEST
...
public class GlobalErrorHandler {
  ...
  //WEEK 15: Handler for the MethodArgumentTypeMismatchException exception
  ...
  //WEEK 15: Spring will intercept a no such element exception, it will call this method, and then will pass in the exception. This is for NOT_FOUND
  ...
  //WEEK 15: this is for an unknown, generic exception
  ...
  private Map<String, Object> createExceptionMessage(Exception e, HttpStatus status, WebRequest webRequest, LogStatus logStatus) {
    ...
    //WEEK 15: this builds the error message
